...
import card3 from '../assets/images/card4.jpg'
import WBTC from '../assets/images/wbtc.png'

const BalanceCard = ({ balance, validDate, cardHolder, img }) => {
    return (
        <>
            <Stack bgImage={card3} justify={'space-between'} bgPos={'center'} bgSize={'cover'} h={'56'} w={{lg:'23rem'}} borderRadius={'lg'} p={'8'} color={'white'}>
                <Stack spacing={'-1'}>
                    ...
                    <HStack justify={'space-between'}>
                        {balance ? (
                            ...
                            <Text fontWeight={'bold'} fontSize={'3xl'}>0 WBTC</Text>
                        )
                        }
                        <Img src={WBTC} objectFit={'cover'} boxSize={'10'} />
                    </HStack>
                </Stack>
